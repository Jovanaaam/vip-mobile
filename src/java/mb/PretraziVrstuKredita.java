...
public class PretraziVrstuKredita {
 ...
 int idvrstezabrisanje;
   ...
   public void obrisiVrstuKredita(){
       if(idvrstekredita == 0){
            ...
            fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Greska","Morate izabrati jednu vrstu kredita za brisanje."));
            return;
       ...
       if (uspesno) {
            ...
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, new FacesMessage("Uspešna izmena", "Vrsta kredita je uspešno izmenjena."));
